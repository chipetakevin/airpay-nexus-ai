    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30">
      ...
      <div className="bg-white/95 backdrop-blur-md border-b border-gray-200/50 shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto p-4 md:p-6">
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-3xl p-2 shadow-xl border-2 border-gray-100">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
              {navigationTabs.map((tab) => (
                <button
                  ...
                  className={`
                    relative group p-4 md:p-6 rounded-2xl transition-all duration-500 transform
                    ${activeTab === tab.id 
                ...
                >
                  <div className="flex flex-col items-center gap-3">
                    <div className={`text-3xl md:text-4xl ${activeTab === tab.id ? 'animate-bounce' : 'group-hover:animate-pulse'}`}>
                      {tab.emoji}
                    </div>
