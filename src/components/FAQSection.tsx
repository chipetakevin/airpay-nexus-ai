...
const FAQSection = () => {
  const faqs = [
    ...
    {
      question: "Is it safe to use AirPay?",
    ...
    },
    {
      ...
      answer: "You can access AirPay services by dialing *120*888# from any mobile phone. This works on all networks without needing the app or internet connection."
    }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Everything you need to know about AirPay
          </p>
        </div>
