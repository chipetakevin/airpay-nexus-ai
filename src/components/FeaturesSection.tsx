  ...
  return (
    <section className="py-16 sm:py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm">
            ...
            <div className="flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-md">
              ...
              <span className="font-semibold text-gray-700">5 Networks</span>
            </div>
            <div className="flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-md">
        ...
        {/* Additional Network Support Visualization */}
        <div className="mt-16 text-center">
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Multi-Network Support</h3>
            <div className="flex flex-wrap justify-center gap-4 mb-6">
              {['MTN', 'Vodacom', 'Cell C', 'Telkom', 'Rain'].map((network, index) => (
                <div key={network} className="flex flex-col items-center">
                  <div className={`w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-white font-bold text-sm shadow-lg transform hover:scale-110 transition-all duration-300`} style={{ animationDelay: `${index * 0.1}s` }}>
                    {network}
                  </div>
                  <div className="w-1 h-8 bg-gradient-to-b from-blue-500 to-transparent mt-2"></div>
                </div>
              ))}
            </div>
            <p className="text-gray-600">All major South African networks - all in one platform</p>
          </div>
        </div>
      </div>
    </section>
