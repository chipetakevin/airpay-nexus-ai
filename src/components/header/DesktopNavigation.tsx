...
const DesktopNavigation = ({ isHomePage, handleQuickShopClick }: DesktopNavigationProps) => {
  ...
  return (
    <>
      {/* Desktop Navigation - Full Header with Consistent Spacing */}
      <div className="hidden md:flex items-center justify-between w-full px-8">
        
        {/* Main Navigation */}
        <nav className="flex items-center space-x-8 lg:space-x-10 xl:space-x-12">
          {navigationItems
            .filter(item => {
        ...
        {/* Right Side Actions - Consistent Spacing */}
        <div className="flex items-center space-x-8 lg:space-x-10 xl:space-x-12">
          
          {/* Buy Airtime & Data Tab */}
          {isHomePage && (
            <button
              onClick={handleQuickShopClick}
              className="relative px-6 py-3 rounded-xl transition-all duration-300 flex items-center gap-2 font-medium bg-gradient-to-r from-emerald-500 to-green-600 text-white hover:from-emerald-600 hover:to-green-700 shadow-xl hover:scale-105 min-w-[140px] lg:min-w-[160px] justify-center"
            >
          ...
          {isAuthenticated ? (
            <div className="flex items-center space-x-4">
              <div className="flex items-center gap-2 bg-white/15 text-white px-6 py-3 rounded-xl border border-white/20 min-w-[120px] justify-center">
              ...
              <Button
                ...
                variant="outline"
                className="bg-red-500/15 text-white border-red-300/30 hover:bg-red-500 hover:text-white transition-all duration-300 font-semibold px-6 py-3 rounded-xl hover:scale-105 min-w-[100px]"
              >
            ...
            <Button
              ...
              variant="outline"
              className="bg-white/15 text-white border-white/30 hover:bg-white hover:text-[#75B8FA] transition-all duration-300 font-semibold px-6 py-3 rounded-xl hover:scale-105 min-w-[140px] lg:min-w-[160px] justify-center"
            >
              <LogIn className="w-4 h-4" />
              <span className="ml-2 text-sm lg:text-base">Login</span>
            </Button>
          )}
          ...
          <Button
            ...
            variant="outline"
            className="bg-white/15 text-white border-white/30 hover:bg-white hover:text-[#75B8FA] transition-all duration-300 font-semibold px-6 py-3 rounded-xl hover:scale-105 min-w-[140px] lg:min-w-[160px] justify-center shadow-lg"
            title="WhatsApp Support"
          >
            <MessageCircle className="w-4 h-4" />
            <span className="ml-2 text-sm lg:text-base">Support</span>
          </Button>
        </div>
      </div>
