...
const QuickActions = ({ onTabChange }: QuickActionsProps) => {
  ...
  const handleUserManagement = () => {
    ...
    if (onTabChange) {
      onTabChange('cdp'); // Navigate to Customer CDP for user management
    }
  };
  ...
  const handleSystemSettings = () => {
    ...
    if (onTabChange) {
      onTabChange('agentic-ai'); // Navigate to Agentic AI for system settings
    }
  };
  ...
  const handleAnalytics = () => {
    ...
    if (onTabChange) {
      onTabChange('data-mesh'); // Navigate to Data Mesh for analytics
    }
  };
