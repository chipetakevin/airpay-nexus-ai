    ...
    <>
      ...
      >
        <CardContent className="p-3">
          <div className="flex items-center justify-between w-full gap-3">
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              <div className="w-10 h-10 bg-gradient-to-r from-gray-400 to-gray-500 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
                {user.firstName?.charAt(0)}{user.lastName?.charAt(0)}
              </div>
              <div className="text-left min-w-0 flex-1">
                <div className="font-medium text-gray-700 text-sm truncate leading-tight">
                  {user.firstName} {user.lastName}
                </div>
                <div className="mt-1">
                  <Badge className="bg-gray-200 text-gray-600 text-xs border-gray-300 px-2 py-0.5 font-medium">
                    Disabled
                  </Badge>
                </div>
              </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <div className="flex items-center gap-1">
                <Unlock className="w-3.5 h-3.5 text-gray-500 group-hover:text-blue-500 transition-colors" />
        ...
        <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center">
          <div className="text-xs text-blue-600 font-medium bg-white/95 px-3 py-1.5 rounded-md shadow-sm border border-blue-100">
            Click to enable
          </div>
        </div>
      </Card>
