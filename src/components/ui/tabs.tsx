...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 p-1 text-muted-foreground shadow-lg border border-gray-200/50 backdrop-blur-sm",
      className
    )}
    {...props}
  />
