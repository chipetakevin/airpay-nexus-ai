...
import { Shield, UserPlus, MessageCircle, AlertTriangle, CheckCircle } from 'lucide-react';
        ...
        <CardContent className="p-6 text-center space-y-4">
          ...
          <div>
            <h3 className="text-lg font-semibold text-red-800 mb-2">
              Registration Required for WhatsApp Shopping
            </h3>
          ...
          <div className="bg-white p-4 rounded-lg border border-red-200">
            <h4 className="font-semibold text-gray-900 mb-3">✨ What you'll get after registration:</h4>
            <div className="space-y-2 text-left">
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-600" />
                <span className="text-sm text-gray-700">Personalized WhatsApp greetings with your name</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-600" />
                <span className="text-sm text-gray-700">Auto-filled phone number for quick purchases</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-600" />
                <span className="text-sm text-gray-700">Direct WhatsApp integration with your registered number</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-600" />
                <span className="text-sm text-gray-700">Access to customer, vendor, or admin features</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-600" />
                <span className="text-sm text-gray-700">Seamless mobile-optimized shopping experience</span>
              </div>
            </div>
          </div>
